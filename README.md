...
| supportDblclickFullscreen             | 是否双击全屏                        | false|
...
| MSE          | MSE模式                       | Boolean | true                                                                                                              |
| WCS          | WCS模式                       | Boolean | true                                                                                                              |
| WASM         | WASM模式                      | Boolean | true                                                                                                              |
| WASMSIMD     | WASMSIMD模式                  | Boolean | true                                                                                                              |
...
| ptzConfig    | PTZ配置                       | Object  | {ptz: false, ptzMore: false}                                                                                       |
| debug        | 控制台日志打印                     | Boolean | false                                                                                                             |
| btns         | 按钮列表                        | Object  | {fullscreen:true,screenshot:true,play:true,audio:true,record:true,stretch:true,zoom:true,ptz:false,quality:false} |
注:
